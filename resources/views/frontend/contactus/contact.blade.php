                ...
                <div class="contact-details-wrapper section-top-gap-100" data-aos="fade-up"  data-aos-delay="0">
                    <div class="contact-details">
                        ...
                        <div class="contact-details-single-item">
                            ...
                            <div class="contact-details-content contact-phone">
                                <a href="tel:+{{ getConfigValueFormSettingTable('phone_contact') }}">{{ getConfigValueFormSettingTable('phone_contact') }}</a>
                                <a href="tel:+{{ getConfigValueFormSettingTable('phone_contact') }}">{{ getConfigValueFormSettingTable('phone_contact') }}</a>
                            </div>
                        ...
                        <div class="contact-details-single-item">
                            ...
                            <div class="contact-details-content contact-phone">
                                <a href="mailto:{{getConfigValueFormSettingTable('email') }}">{{getConfigValueFormSettingTable('email') }}</a>
                            </div>
                        </div> <!-- End Contact Details Single Item -->
                        <!-- Start Contact Details Single Item -->
                        <div class="contact-details-single-item">
                            ...
                            <div class="contact-details-content contact-phone">
                                ...
                                <span>{{getConfigValueFormSettingTable('address') }}</span>
                            </div>
                        </div> <!-- End Contact Details Single Item -->
                    </div>
                    ...
                    <div class="contact-social">
                        ...
                        <ul>
                            ...
                            <li><a href="{{getConfigValueFormSettingTable('facebook_link') }}"><i class="fa fa-youtube"></i></a></li>
                            <li><a href="{{getConfigValueFormSettingTable('email') }}"><i class="fa fa-google-plus"></i></a></li>
