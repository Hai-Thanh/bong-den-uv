...
<div class="breadcrumb-section breadcrumb-bg-color--golden">
    <div class="breadcrumb-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h3 class="breadcrumb-title">Shop - {{ $catename->name }}</h3>
                    <div class="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                        <nav aria-label="breadcrumb">
                            <ul>
                                <li><a href="{{ route('home') }}">Home</a></li>
                                <li><a href="{{ route('shop') }}">Shop</a></li>
                                <li class="active" aria-current="page"> {{ $catename->name }}  </li>
                            </ul>
                        </nav>
                    </div>
                </div>
                                                    ...
                                                    <div class="image-box">
                                                        ...
                                                        <div class="action-link">
                                                            <div class="action-link-left">
                                                                <a href="#" class="add-cart" data-url="{{ route('add-to-cart' , ['id' =>$product]) }}" data-bs-toggle="modal" data-bs-target="#modalAddcart">Add to Cart</a>
                                                            </div>
                                                ...
                                                <div class="product-list-single product-color--golden">
                                                    ...
                                                    <div class="product-list-content">
                                                        ...
                                                        <div class="product-action-icon-link-list">
                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#modalAddcart"  data-url="{{ route('add-to-cart' , ['id' =>$product->id]) }}" class="add-cart btn btn-lg btn-black-default-hover">Add to cart</a>
