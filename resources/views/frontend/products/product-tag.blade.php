...
<div class="breadcrumb-section breadcrumb-bg-color--golden">
    <div class="breadcrumb-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h3 class="breadcrumb-title">Shop - Tag</h3>
                            ...
                            <div class="col-12">
                                <div class="tab-content tab-animate-zoom">
                                    ...
                                    <div class="tab-pane active show sort-layout-single" id="layout-3-grid">
                                        <div class="row">
                                     @foreach ($tag->productTag  as  $product)
                                                    ...
                                                    <div class="image-box">
                                                        ...
                                                        <div class="action-link">
                                                            <div class="action-link-left">
                                                                <a href="#" data-bs-toggle="modal" class="add-cart" data-bs-target="#modalAddcart" data-url="{{ route('add-to-cart' , ['id' =>$product->id]) }}">Add to Cart</a>
                                                            </div>
                                                ...
                                                <div class="product-list-single product-color--golden">
                                                    ...
                                                    <div class="product-list-content">
                                                        ...
                                                        <div class="product-action-icon-link-list">
                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#modalAddcart"  class="add-cart btn btn-lg btn-black-default-hover" data-url="{{ route('add-to-cart' , ['id' =>$product->id]) }}"  >Add to cart</a>
