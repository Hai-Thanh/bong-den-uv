            ...
            <div class="row d-flex align-items-center justify-content-between d-sm-column">
                ...
                <div class="col-md-6">
                    <div class="content" data-aos="fade-up"  data-aos-delay="200">
                            ...
                            <h5 class="semi-title">{{ $about->description }} </h5>
                            <p>{{ $about->content }}</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    ...
                    <div class="image">
                            <img src="{{ asset('shop-hono/assets/images/icons/icon_about1.jpg') }}" alt="">
                    </div>
                        <div class="content">
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    ...
                    <div class="image">
                            <img src="{{ asset('shop-hono/assets/images/icons/icon_about2.jpg') }}" alt="">
                    </div>
                        <div class="content">
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    ...
                    <div class="image">
                            <img src="{{ asset('shop-hono/assets/images/icons/icon_about3.jpg') }}" alt="">
                    </div>
                        <div class="content">
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    ...
                    <div class="image">
                            <img src="{{ asset('shop-hono/assets/images/icons/icon_about4.jpg') }}" alt="">
                    </div>
                        <div class="content">
            ...
            <div class="row mb-n6">
                <div class="col-xl-3 mb-5">
                    <div class="team-single" data-aos="fade-up"  data-aos-delay="0">
                        <div class="team-img">
                            <img class="img-fluid" src="{{ asset('shop-hono/assets/images/team/leader1.png') }}" alt="">
                        </div>
                ...
                <div class="col-xl-3 mb-5">
                    <div class="team-single" data-aos="fade-up"  data-aos-delay="200">
                        <div class="team-img">
                            <img class="img-fluid" src="{{ asset('shop-hono/assets/images/team/leader2.png') }}" alt="">
                        </div>
                        <div class="team-content">
                ...
                <div class="col-xl-3 mb-5">
                    <div class="team-single" data-aos="fade-up"  data-aos-delay="400">
                        <div class="team-img">
                            <img class="img-fluid" src="{{ asset('shop-hono/assets/images/team/leader3.png') }}" alt="">
                        </div>
                        <div class="team-content">
                            <h6 class="team-name font--bold mt-5">Missa Santos</h6>
                ...
                <div class="col-xl-3 mb-5">
                    <div class="team-single" data-aos="fade-up"  data-aos-delay="600">
                        <div class="team-img">
                            <img class="img-fluid" src="{{ asset('shop-hono/assets/images/team/leader4.png') }}" alt="">
                        </div>
                        <div class="team-content">
