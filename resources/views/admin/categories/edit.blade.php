...
@include('admin.partials.title-content', ['name'=>'Sửa danh mục'])

    <form action="{{ url("admin/categories/update/$category->id") }}" class="add-new-post" method="POST">
        @csrf
            <div class="form-group  col-md-6 ">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" value="{{ $category->name }}" name="name" id="iputName" class="form-control" placeholder="Nhập tên danh mục" > 
                </div>
            ...
            <div class="form-group col-md-6">
                ...
                <div class="input-group">
                    ...
                    <input id="image_path" value="{{ $category->image_path }}" class="form-control" type="text" name="image_path">
                  </div>
                ...
                @enderror
                <div   id="holder">
                <img  src=" {{$category->image_path  }}"  style="margin-top:15px;max-height:100px;">
                </div>
            </div>
