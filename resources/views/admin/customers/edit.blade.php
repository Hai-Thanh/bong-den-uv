...
@section('title', 'Trang thông tin sửa khách hàng')
...
@section('content')
    <div class="main-content-container container-fluid px-4">
        @include('admin.partials.title-content', ['name'=>'Trang thông tin sửa khách hàng'])
                            ...
                            <div class="card card-small mb-4">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item p-3">
                                        <div class="row">
                                            <div class="col">
                                                <form action="{{ route('customers.update' , ['id' => $customer->id]) }}" enctype="multipart/form-data" class="add-new-post" method="POST">
                                                   @csrf
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input  value="{{ $customer->avatar }}" id="avatar" class="form-control" type="text" name="avatar">
                                                            </div>
                                                        </div>
                                                    </div>  
