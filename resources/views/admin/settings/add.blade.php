...
@include('admin.partials.title-content', ['name'=>'Thêm settings'])


<form action="{{route('setting.store')}}" class="add-new-post" method="POST">
    @csrf
        ...
        <div class="form-group col-md-6">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" name="config_key"  class="form-control" placeholder="Config Key" > 
            </div>
        </div>
        ...
        <div class="form-group col-md-6">
            ...
            <div class="input-group mb-6">
               <textarea class="form-control" name="config_value"  cols="90" rows="10"></textarea>
            </div>
        </div>
